...
export default async function CustomerHomePage() {
  ...
  return (
    <div className={`${manrope.variable} ${inter.variable} font-[var(--font-inter)] bg-slate-50 min-h-screen text-slate-900`}>
      <header className="fixed top-0 left-0 right-0 z-40 flex items-center justify-between px-6 py-3 bg-white/80 backdrop-blur-xl shadow-sm">
      ...
      <main className="pt-20 pb-32 px-6 max-w-md mx-auto">
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            >
              <span className="w-full aspect-square rounded-3xl bg-white flex items-center justify-center shadow-sm border border-slate-100">
        ...
        <section className="mb-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-[#0061FF]">
              See all
            </span>
          </div>
          <div className="space-y-3">
            {data.recentActivity.length === 0 ? (
              ...
              data.recentActivity.map((activity) => (
                <div
                  key={activity.id}
                  className="bg-white p-4 rounded-2xl flex items-center gap-4 shadow-sm border border-slate-100"
                >
      ...
      <nav className="fixed bottom-0 left-0 right-0 z-40 flex justify-around items-center px-4 pb-6 pt-3 bg-white/90 backdrop-blur-lg shadow-[0_-4px_20px_rgba(0,0,0,0.05)] rounded-t-3xl">
        <Link
          href="/customers"
